...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Register || KHAREED LO</title>
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="eg:123" name="pin">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="abc@abc.com" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
